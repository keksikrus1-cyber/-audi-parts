...
**Отложено.** Мобильное приложение не входит в текущий этап разработки AudiParts. Работа над `mobile` начнётся после завершения веб-версии MVP. Не запускать Expo/EAS/Maestro до явного разрешения.
